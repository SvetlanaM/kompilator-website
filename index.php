...
<body class="bg-white gray">
            ...
            <div id="carousel-fade" class="carousel slide carousel-fade mt-40" data-interval="false" data-ride="carousel" data-pause="hover">
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        ...
                        <div class="carousel-caption col-md-11 col-lg-8 pl-5">
                            ...
                            <ul class="list-inline list-unstyled carousel-tags mt-4">
                                ...
                                <li class="carousel-tag-item list-inline-item">Backend vývoj</li>
                                <li class="carousel-tag-item list-inline-item">Firebase</li>
                                <li class="carousel-tag-item list-inline-item">iOS vývoj</li>
                                <li class="carousel-tag-item list-inline-item">Android vývoj</li>
                                <li class="carousel-tag-item list-inline-item">Marketing</li>

                            </ul>
                            <button type="button" class="btn-study btn col-auto p-0">
                                <a href="../otkd.html">ZOBRAZIT PŘÍPADOVOU STUDII</a></button>
                        </div>
                        <img class="carousel-image" srcset="img/slide1@2.webp 2x, 
                                img/slide1@2.webp 2x,
                                img/slide1@3.webp 3x" alt="Mobilní aplikace pro závody Od Tatier k Dunaju" />
                    </div>
                    ...
                    <div class="carousel-item">
                        ...
                        <img class="carousel-image" srcset="img/slide2@1.webp 1x, 
                                img/slide2@2.webp 2x,
                                img/slide2@3.webp 3x" alt="Pro limo services - online limuzíny" />
                    </div>
                    <div class="carousel-item">
                        ...
                        <img class="carousel-image" srcset="img/mockup_slide3x3.webp 1x, 
                                img/mockup_slide3x3.webp 2x,
                                img/mockup_slide3x3.webp 3x" alt="Mobilná aplikace pro degustace v Čajovně Setkání" />
                    </div>
                    <div class="carousel-item">
                        ...
                        <img class="carousel-image" srcset="img/slide3@1.webp 1x, 
                                img/slide3@2.webp 2x,
                                img/slide3@3.webp 3x" alt="Find my Star - mobilní aplikace na vyhledávání hvězd" />
                    </div>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-8 order-1 order-lg-2 pb-5 pl-md-5">
                    ...
                    <div class="logos mt-40 d-none d-md-flex flex-wrap justify-content-between">
                        <img src="img/svg/design_thinking.svg" alt="Design Thinking" class="img-fluid" />
                        <img src="img/svg/agile.svg" alt="Agilní vývoj" class="img-fluid" />
                        <img src="img/svg/firebase.svg" alt="Firebase databáze" class="img-fluid" />
                        <img src="img/svg/data.svg" alt="Datová analýza a rozhodování" class="img-fluid" />
                    </div>
                </div>
            </div>
        </div>
    ...
    <script src="vendor/jquery/jquery.slim.min.js" integrity="sha384-KJ3o2DKtIkvYIK3UENzmM7KCkRr/rE9/Qpg6aAZGJwFDMVNA/GpGFF93hXpG5KkN" crossorigin="anonymous">
    </script>
