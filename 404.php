...
<head>
    ...
    <meta name="twitter:description" content="Měníme nápady na reálné digitální produkty. Pomáháme s rebrandingem, redesignem a tvorbou nového brandu. Zaměřujeme se primárně na
         design, UI / UX a uživatelský přístup. Neustále se ptáme a posloucháme. S námi vytvoříte užitečné webové
         a mobilní aplikace, které jsou zde pro uživatele. Už žádné nedorozumění mezi IT a byznysem, všichni
         pracujeme jako jeden tým.">
    ...
    <meta property="og:description" content="Měníme nápady na reálné digitální produkty. Pomáháme s rebrandingem, redesignem a tvorbou nového brandu. Zaměřujeme se primárně na
         design, UI / UX a uživatelský přístup. Neustále se ptáme a posloucháme. S námi vytvoříte užitečné webové
         a mobilní aplikace, které jsou zde pro uživatele. Už žádné nedorozumění mezi IT a byznysem, všichni
         pracujeme jako jeden tým." />
    ...
    <section id="banner" class="banner">
        <div class="container-fluid pl-md-5 pr-md-5">
            <div class="row no-gutters">
                <div class="col-lg d-lg-flex justify-content-start d-none">
                    <img src="img/svg/lost.svg" class="img-fluid img-banner" alt="Produkty, ktoré zarábajú" />
                </div>

                <div class="col-lg pr-lg-5">
                    <h1 class="purple fw-500 banner-title">Ztratili jste se?</h1>
                    <p class="mt-40">Compilation Error: Ajaj, zabloudili jste na cestu, kde nic není. Pomůžeme vám vrátit sa zpět. <br /><br />
                        Přepočítávání trasy...
                    </p>
                    <div class="ca-buttons">
                        <a href="../"><button class="order">Úvodní stránka</button></a>
                        <a href="mailto:svetlana@kompilator.cz" target="new"><button class="show-ref">Napište nám ></button></a>
                    </div>
                    </p>
                </div>
            </div>
